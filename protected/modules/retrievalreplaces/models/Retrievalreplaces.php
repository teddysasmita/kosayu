...
/**
 * This is the model class for table "retrievalreplaces".
 *
 * The followings are the available columns in table 'retrievalreplaces':
 * @property string $id
 ...
 */
class Retrievalreplaces extends CActiveRecord
{
	/**
	 ...
	 * @return Retrievalreplaces the static model class
	 */
