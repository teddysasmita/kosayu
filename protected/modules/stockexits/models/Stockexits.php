...
/**
 * This is the model class for table "stockexits".
 *
 * The followings are the available columns in table 'stockexits':
 * @property string $id
 ...
 */
class Stockexits extends CActiveRecord
{
	/**
	 ...
	 * @return Stockexits the static model class
	 */
