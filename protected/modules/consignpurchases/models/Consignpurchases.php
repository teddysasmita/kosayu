...
/**
 * This is the model class for table "consignpurchasesorders".
 *
 * The followings are the available columns in table 'consignpurchasesorders':
 * @property string $id
 ...
 */
class Consignpurchases extends CActiveRecord
{
	/**
	 ...
	 * @return Consignpurchasesorders the static model class
	 */
