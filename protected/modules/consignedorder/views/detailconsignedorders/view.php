...
$this->menu=array(
	...
	array('label'=>'Update Detailconsignedorders', 'url'=>array('update', 'id'=>$model->iddetail)),
	array('label'=>'Delete Detailconsignedorders', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->iddetail),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Manage Detailconsignedorders', 'url'=>array('admin')),
   array('label'=>'Ubah Detil', 'url'=>array('/consignedorder/detailconsignedorders/update',
