...
/**
 * This is the model class for table "detailconsignedorders2".
 *
 * The followings are the available columns in table 'detailconsignedorders2':
 ...
 */
class Detailconsignedorders2 extends CActiveRecord
{
	/**
	 ...
	 * @return Detailconsignedorders2 the static model class
	 */
