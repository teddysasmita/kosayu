...
/**
 * This is the model class for table "consignedorders".
 *
 * The followings are the available columns in table 'consignedorders':
 * @property string $id
 ...
 */
class Consignedorders extends CActiveRecord
{
	/**
	 ...
	 * @return Consignedorders the static model class
	 */
