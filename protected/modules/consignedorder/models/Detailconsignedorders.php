...
/**
 * This is the model class for table "detailconsignedorders".
 *
 * The followings are the available columns in table 'detailconsignedorders':
 ...
 */
class Detailconsignedorders extends CActiveRecord
{
	/**
	 ...
	 * @return Detailconsignedorders the static model class
	 */
