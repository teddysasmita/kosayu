...
/**
 * This is the model class for table "stickertoguides".
 *
 * The followings are the available columns in table 'stickertoguides':
 * @property string $id
 ...
 */
class Stickertoguides extends CActiveRecord
{
	/**
	 ...
	 * @return Stickertoguides the static model class
	 */
