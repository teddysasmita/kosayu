...
/**
 * This is the model class for table "detailsendrepairs".
 *
 * The followings are the available columns in table 'detailsendrepairs':
 ...
 */
class Detailreceiverepairs extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('iddetail, id, iditem, entry, serialnum, idwarehouse, selected, userlog, datetimelog', 'required'),
			array('iddetail, id, iditem, idwarehouse, userlog', 'length', 'max'=>21),
			array('datetimelog', 'length', 'max'=>19),
			array('serialnum', 'length', 'max'=>50),
			array('entry, selected', 'length', 'max'=>1),
	 ...
	 * @return Detailsendrepairs the static model class
	 */
