...
/**
 * This is the model class for table "purchasesreturs".
 *
 * The followings are the available columns in table 'purchasesreturs':
 * @property string $id
 ...
 */
class Purchasesreturs extends CActiveRecord
{
	/**
	 ...
	 * @return Purchasesreturs the static model class
	 */
