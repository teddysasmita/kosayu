...
class MYPDF extends TCPDF {
	...
	public function LoadData($data, array $detaildata) {
		...
		$this->headerwidths = array(30, 80, 15, 20, 40);
	}
	...
	public function master()
	{
		...
		$this->setFontSize(15);
		$this->setXY(10, 10);
		$this->Cell(195, 10, 'Nota Retur ke Pemasok', 'LTR', 1, 'C');
		$this->SetFontSize(10);
		$this->SetFont('Helvetica', 'B');
		$this->setXY(10, 20);
...
function execute($model, $detailmodel) {
	...
	$pdf->Output('Retur ke Pemasok-'.$model->regnum.'-'.idmaker::getDateTime().'.pdf', 'D');
}
//============================================================+
// END OF FILE                                                
//============================================================+
