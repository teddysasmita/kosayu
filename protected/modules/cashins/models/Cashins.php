...
/**
 * This is the model class for table "cashins".
 *
 * The followings are the available columns in table 'cashinss':
 * @property string $id
 * @property string $idatetime
 * @property string $regnum
 * @property string $idcash
 ...
 */
class Cashins extends CActiveRecord
{
	/**
	...
	public function search()
	{
		...
		$criteria->compare('idcash',$this->idcash,true);
	 ...
	 * @return Cashinss the static model class
	 */
