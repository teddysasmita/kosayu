...
$this->menu=array(
	...
	array('label'=>'Update Detailorderretrievals', 'url'=>array('update', 'id'=>$model->iddetail)),
	array('label'=>'Delete Detailorderretrievals', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->iddetail),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Manage Detailorderretrievals', 'url'=>array('admin')),
   array('label'=>'Ubah Detil', 'url'=>array('/purchasesorder/detailorderretrievals/update',
