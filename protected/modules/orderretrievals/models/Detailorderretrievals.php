...
/**
 * This is the model class for table "detailorderretrievals".
 *
 * The followings are the available columns in table 'detailorderretrievals':
 ...
 */
class Detailorderretrievals extends CActiveRecord
{
	/**
	 ...
	 * @return Detailorderretrievals the static model class
	 */
