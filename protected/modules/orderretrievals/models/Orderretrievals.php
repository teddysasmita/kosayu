...
/**
 * This is the model class for table "orderretrievals".
 *
 * The followings are the available columns in table 'orderretrievals':
 * @property string $id
 ...
 */
class Orderretrievals extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id, regnum, idatetime, invnum, receivername, receiveraddress, receiverphone, status, userlog, datetimelog', 'required'),
			array('id, userlog', 'length', 'max'=>21),
			array('regnum, invnum', 'length', 'max'=>12),
			array('idatetime, datetimelog', 'length', 'max'=>19),
			array('receiveraddress', 'length', 'max'=>200),
			array('receiverphone', 'length', 'max'=>50),
			array('receivername', 'length', 'max'=>100),
			array('status', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, regnum, idatetime, invnum, receivername, receiveraddress, receiverphone, status, userlog, datetimelog', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Orderretrievals the static model class
	 */
