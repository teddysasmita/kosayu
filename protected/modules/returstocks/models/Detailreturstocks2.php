...
/**
 * This is the model class for table "detailreturstocks2".
 *
 * The followings are the available columns in table 'detailreturstocks2':
 ...
 */
class Detailreturstocks2 extends CActiveRecord
{
	/**
	 ...
	 * @return Detailreturstocks2 the static model class
	 */
