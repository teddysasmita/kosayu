...
/**
 * This is the model class for table "detailreturstocks".
 *
 * The followings are the available columns in table 'detailreturstocks':
 ...
 */
class Detailreturstocks extends CActiveRecord
{
	/**
	 ...
	 * @return Detailreturstocks the static model class
	 */
