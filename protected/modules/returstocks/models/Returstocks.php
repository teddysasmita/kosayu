...
/**
 * This is the model class for table "returstocks".
 *
 * The followings are the available columns in table 'returstocks':
 * @property string $id
...
class Returstocks extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, idatetime, regnum,idsupplier, userlog, datetimelog', 'required'),
