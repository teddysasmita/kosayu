...
<?php
    ...
    $itemScript=<<<EOS
      $('#Detailreturstocks_itemname').focus(function(){
...
EOS;
 ...
 ?>
	...
	<div class="row">
		...
		<?php 
               echo CHtml::textField('Detailreturstocks_itemname', lookup::ItemNameFromItemID($model->iditem) , array('size'=>50));   
                  ...
                  'options'=>array(
                      ...
                      'buttons'=>array(
                          array('text'=>'Ok', 'click'=>'js:function(){
                             $(\'#Detailreturstocks_itemname\').val($(\'#dialog-item-name\').val());
                             $.get(\'index.php?r=LookUp/getItemID\',{ name: encodeURI($(\'#dialog-item-name\').val()) },
                                 function(data) {
                                    $(\'#Detailreturstocks_iditem\').val(data);
                                 })
                             $(this).dialog("close");
                           }'),
