...
/**
 * This is the model class for table "detailsalesreturs".
 *
 * The followings are the available columns in table 'detailsalesreturs':
 ...
 */
class Detailsalesreturs extends CActiveRecord
{
	/**
	 ...
	 * @return Detailsalesreturs the static model class
	 */
