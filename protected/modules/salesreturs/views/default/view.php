...
$this->menu=array(
	...
	array('label'=>'Pencarian Data', 'url'=>array('admin')),
      ...
      array('label'=>'Data Detil yang dihapus', 
         'url'=>array('/purchasesorder/detailsalesreturs/deleted', 'id'=>$model->id)),
...
<?php 
   $count=Yii::app()->db->createCommand("select count(*) from detailsalesreturs2 where id='$model->id'")
      ->queryScalar();
   $sql="select * from detailsalesreturs2 where id='$model->id'";
   ...
   $count=Yii::app()->db->createCommand("select count(*) from detailsalesreturs where id='$model->id'")
      ->queryScalar();
