...
/**
 * This is the model class for table "detaildeliveryreplaces".
 *
 * The followings are the available columns in table 'detaildeliveryreplaces':
 ...
 */
class Detaildeliveryreplaces extends CActiveRecord
{
	/**
	 ...
	 * @return Detaildeliveryreplaces the static model class
	 */
