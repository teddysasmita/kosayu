...
/**
 * This is the model class for table "detailstockdamage".
 *
 * The followings are the available columns in table 'detailstockdamage':
 ...
 */
class Detailstockdamage extends CActiveRecord
{
	/**
	 ...
	 * @return Detailstockdamage the static model class
	 */
