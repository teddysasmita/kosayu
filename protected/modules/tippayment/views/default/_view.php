...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('idsticker')); ?>:</b>
	<?php echo CHtml::encode($data->idsticker); ?>
	<br />
	
	<b><?php echo CHtml::encode($data->getAttributeLabel('ddatetime')); ?>:</b>
	<?php echo CHtml::encode($data->ddatetime); ?>
	<br />
