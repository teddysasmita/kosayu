...
/**
 * This is the model class for table "detailerrors".
 *
 * The followings are the available columns in table 'detailerrors':
 ...
 */
class Detailerrors extends CActiveRecord
{
	/**
	 ...
	 * @return Detailerrors the static model class
	 */
