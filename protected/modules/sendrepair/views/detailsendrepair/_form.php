...
EOS;
 ...
 ?>
	...
	<div class="row">
		...
		<?php 
               echo CHtml::textField('Detailsendrepairs_itemname', lookup::ItemNameFromItemID($model->iditem) , array('size'=>50));   
                  ...
                  'options'=>array(
                      ...
                      'buttons'=>array(
                          array('text'=>'Ok', 'click'=>'js:function(){
                             $(\'#Detailsendrepairs_itemname\').val($(\'#dialog-item-name\').val());
                             $.get(\'index.php?r=LookUp/getItemID\',{ name: encodeURI($(\'#dialog-item-name\').val()) },
                                 function(data) {
                                    $(\'#Detailsendrepairs_iditem\').val(data);
                                 })
                             $(this).dialog("close");
                           }'),
