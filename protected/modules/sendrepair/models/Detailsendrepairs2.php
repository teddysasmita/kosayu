...
/**
 * This is the model class for table "detailsendrepairs2".
 *
 * The followings are the available columns in table 'detailsendrepairs2':
 ...
 */
class Detailsendrepairs2 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('iddetail, id, iditem, serialnum, remark, userlog, datetimelog', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Detailsendrepairs2 the static model class
	 */
