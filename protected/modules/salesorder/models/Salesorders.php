...
/**
 * This is the model class for table "salesorders".
 *
 * The followings are the available columns in table 'salesorders':
 * @property string $id
...
class Salesorders extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, regnum, idatetime, idcustomer, total, discount, status, rowdeleted, userlog, datetimelog', 'safe', 'on'=>'search'),
		);
	}
