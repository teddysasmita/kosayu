...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'idorder',array('size'=>21,'maxlength'=>21)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'iddetailorder'); ?>
		<?php echo $form->textField($model,'iddetailorder',array('size'=>21,'maxlength'=>21)); ?>
	</div>
