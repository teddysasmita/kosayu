...
/**
 * This is the model class for table "purchasesinvoices".
 *
 * The followings are the available columns in table 'purchasesinvoices':
 * @property string $id
 ...
 */
class Purchasesinvoices extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Purchasesinvoices the static model class
	 */
